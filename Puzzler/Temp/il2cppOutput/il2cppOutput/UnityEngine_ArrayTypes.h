...
// UnityEngine.CanvasRenderer[]
struct CanvasRendererU5BU5D_t3629292454  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) CanvasRenderer_t3950887807 * m_Items[1];

public:
	inline CanvasRenderer_t3950887807 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline CanvasRenderer_t3950887807 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, CanvasRenderer_t3950887807 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
